	...
	const handleLogin = async () => {
		try {
			...
			await syncUserProfile({
				...
				username: credential.user.displayName || verification?.user?.username || 'Explorer',
			...
			<KeyboardAvoidingView
				...
				<ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
					...
					<View style={styles.titleWrap}>
						...
						<Text style={styles.subtitle}>Sign in to continue discovering hidden spots.</Text>
					</View>
					...
					<View style={styles.card}>
						...
						/>
						{isSubmitting ? <Text style={styles.loadingText}>Signing in...</Text> : null}
